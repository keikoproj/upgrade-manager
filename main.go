...
func main() {
	...
	flag.IntVar(&maxBallooning, "max-ballooning", 1000, "The max number of nodes allowed in a cluster. Caps the number of replacement nodes.")
	...
	reconciler.SetMaxBallooning(maxBallooning)

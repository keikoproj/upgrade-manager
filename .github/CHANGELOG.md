...
## [v1.0.11] - 2025-08-15
ee83c02 Bump k8s.io/kubectl from 0.32.3 to 0.32.7 (#523)
38a2220 #7684 cordon nodes race condition (#518)
b3c8eae Bump k8s.io/client-go from 0.32.4 to 0.32.7 (#524)
21a8039 Bump actions/checkout from 4 to 5 (#526)
d82a7a4 Bump k8s.io/client-go from 0.32.3 to 0.32.4 (#507)
7305728 Bump golang.org/x/net from 0.36.0 to 0.38.0 in /test-bdd (#502)
f6ff06e Bump golang.org/x/net from 0.37.0 to 0.38.0 (#503)
f14d58c Bump github.com/prometheus/client_golang from 1.21.1 to 1.22.0 (#501)
681cbb3 Bump github.com/onsi/gomega from 1.36.3 to 1.37.0 (#500)
dc2d66c fix: update codecov config (#499)
cddc611 Bump github.com/keikoproj/aws-sdk-go-cache from 0.0.2 to 0.1.0 (#497)
444ac85 Bump github.com/onsi/gomega from 1.34.1 to 1.36.3 (#494)
dd1cbe8 Bump golang.org/x/net from 0.27.0 to 0.36.0 (#492)
1a9316c Upgrade Go, Kubernetes, and Controller-Runtime Dependencies (#498)
ba3dcd7 Bump github.com/prometheus/client_golang from 1.20.2 to 1.21.1 (#493)
220b2c7 Bump github.com/aws/aws-sdk-go from 1.55.5 to 1.55.6 (#495)
90028f0 Bump golang.org/x/net from 0.23.0 to 0.36.0 in /test-bdd (#490)
ac20ba6 Bump github.com/golang/glog from 1.1.2 to 1.2.4 (#491)
06d3d97 Bump codecov/codecov-action from 4 to 5 (#487)
e5de0d3 Bump busybox from 1.36.1 to 1.37.0 (#484)
25c5500 Bump github.com/prometheus/client_golang from 1.19.1 to 1.20.2 (#480)
3bde584 Bump github.com/aws/aws-sdk-go from 1.54.15 to 1.55.5 (#478)
5116b74 Bump github.com/onsi/gomega from 1.33.1 to 1.34.1 (#477)
0538d9d Bump github.com/aws/aws-sdk-go from 1.54.11 to 1.54.15 (#472)
d041d53 Bump github.com/aws/aws-sdk-go from 1.54.6 to 1.54.11 (#471)
1601680 Bump github.com/aws/aws-sdk-go from 1.51.30 to 1.54.6 (#470)
0edec0a Bump github.com/go-logr/logr from 1.4.1 to 1.4.2 (#462)
3d230c7 Bump github.com/prometheus/client_golang from 1.19.0 to 1.19.1 (#459)
f349a0e Bump golang.org/x/net from 0.17.0 to 0.23.0 in /test-bdd (#444)
88ad204 Bump docker/build-push-action from 5 to 6 (#466)
ece0049 Bump golangci/golangci-lint-action from 5 to 6 (#458)
d0ecfc0 Update codecov GHA config (#468)
825e226 Bump github.com/onsi/gomega from 1.33.0 to 1.33.1 (#456)
48e4d7c Bump golangci/golangci-lint-action from 4 to 5 (#454)
99b7a57 Bump github.com/aws/aws-sdk-go from 1.51.25 to 1.51.30 (#455)
8094bca Bump github.com/onsi/gomega from 1.30.0 to 1.33.0 (#453)
fbc100a Bump go.uber.org/zap from 1.26.0 to 1.27.0 (#452)
affac34 fix: prevent 0 batch size (#348)
0f21bef Bump google.golang.org/protobuf from 1.31.0 to 1.33.0 in /test-bdd (#440)
450336f Bump github.com/go-logr/logr from 1.3.0 to 1.4.1 (#423)
a80aab7 Bump github.com/prometheus/client_golang from 1.17.0 to 1.19.0 (#437)
f9fb9eb Bump github.com/aws/aws-sdk-go from 1.48.16 to 1.51.25 (#450)
8e3006c Update to go 1.21 (#451)
9b95940 Update k8s modules for 1.26 (#448)
e74b967 Fix codecov (#446)
fc5fb01 Update ci.yaml (#445)
b579a02 Bump codecov/codecov-action from 3 to 4 (#430)
